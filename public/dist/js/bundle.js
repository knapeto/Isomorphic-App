	...
	var Router = Backbone.Router.extend({
	    ...
	    default: function(){
	      __webpack_require__.e/*nsure*/(1, function(){
	        ...
	        React.renderComponent(Home(null), $('#content')[0]);
	      });
	    },
	    users: function(){
	      __webpack_require__.e/*nsure*/(2, function(){
	        var User = __webpack_require__(5);
	        React.renderComponent(User(null), $('#content')[0]);
	      });
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(root, factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(31), __webpack_require__(7), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
